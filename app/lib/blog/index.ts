...
import { apartamentTevaPernikChast4ZavarshenDoKluch } from "./posts/apartament-teva-pernik-chast-4-zavarshen-do-kluch";
import { zavurshenObekt6RabotniDniRemontPochistvane } from "./posts/zavurshen-obekt-6-rabotni-dni-remont-pochistvane";
import { apartamentTevaPernikChast2 } from "./posts/apartament-teva-pernik-chast-2";
...
import { ryazaneOpasnoDurvoPernikKladnitsa } from "./posts/ryazane-opasno-durvo-pernik-kladnitsa";
...
export const blogCategories: BlogCategory[] = [
  {
    ...
    metaDescription:
      "Практически съвети от DB-Clean за почистване на дворове, тавани, мазета, рязане на дървета и извозване на отпадъци в София и Перник."
  },
  {
    ...
    metaDescription:
      "Реални истории и случаи от работата на DB-Clean с клиенти в София и Перник — почистване на имоти, разчистване и извозване."
  }
];

export const blogPosts: BlogPost[] = [
  apartamentTevaPernikChast4ZavarshenDoKluch,
  zavurshenObekt6RabotniDniRemontPochistvane,
  apartamentTevaPernikChast2,
  iznasyaneBoklukTevaPernik,
  izvozvaneOtpadaciSledRemontMladost,
  praveneNaZamazkaPodgotovkaRemont,
  razchistvaneDvorDolnaSekirna,
  ryazaneOpasnoDurvoPernikKladnitsa,
